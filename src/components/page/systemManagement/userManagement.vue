    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="email" label="邮件" align="center" width="215" >
            </el-table-column>
            ...
            <el-table-column prop="deptName" label="部门名称" align="center" width="230" >
...
export default {
  ...
  methods: {
    ...
    _httpUserRoleList(userId, row) {
      httpUserRoleList(userId, row).then(res => {
        let data = res.data;
        if (data.code == 200) {
          let list = data.rows;
    ...
    _httpMenuList() {
      ...
      httpRoleList(1, 10000).then(res => {
        ...
        this.init(_this.npage, _this.pagesize);
      });
      // .then(res => {
      //   let data = res.data;
    ...
    init(pageNum, pageSize, Username, ssex, mobile, deptId) {
      ...
      let _this = this;
      this.loading = true;
      httpUserList(pageNum, pageSize, Username, ssex, mobile, deptId).then(
        res => {
          let data = res.data;
          if (data.code == 200) {
        ...
        this.$jQuery.ajax({
          ...
          success: function(data) {
            ...
            if (data.code == 200) {
              ...
              _this.init(_this.npage, _this.pagesize);
            } else if (data.code == 500) {
              this.$message.error(data.msg);
              this.$router.push("/login");
            } else {
